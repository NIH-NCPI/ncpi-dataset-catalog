...
The catalog indexes studies from four platforms and dbGaP:
...
To work with subject-level data, researchers can apply for authorized access through [dbGaP](https://dbgap.ncbi.nlm.nih.gov/) or the Broad Institute's [DUOS](https://duos.broadinstitute.org/) system.
